...
class Application(tk.Tk):
    ...
    def test_speech(self):
        ...
        def _process_test_speech_thread():
            try:
                ...
                success = self.audio.text_to_speech(test_text, "test_output.wav")
        ...
        try:
            ...
            while self.is_conversing and not self.audio.stop_event.is_set():
                ...
                try:
                    ...
                    if not openai.api_key:
                        raise openai.error.AuthenticationError("OpenAI API key not configured.")
                ...
                tts_played_successfully = self.audio.text_to_speech(assistant_response_text, "output.wav")
    ...
    def on_close(self) -> None:
        ...
        if 'sd' in sys.modules:
            ...
            try: sd.stop(ignore_errors=True)
